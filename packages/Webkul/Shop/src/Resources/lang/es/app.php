...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© S Nails Cosmetics - :current_year, Webkul Software (Registrado en India). Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer'           => '© S Nails Cosmetics :current_year. Todos los derechos reservados.',
            'password'         => 'Contraseña',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile'       => 'Perfil',
                        'search'        => 'Buscar',
                        'search-text'   => '¿Qué producto estás buscando?',
                ...
                'mobile' => [
                    ...
                    'dropdown-text' => 'Gestionar carrito, pedidos y lista de deseos',
                    'locales'       => 'Idiomas',
                    'login'         => 'Registrate o inicia sesión',
                    'logout'        => 'Cerrar sesión',
                    'orders'        => 'Pedidos',
                    'profile'       => 'Perfil',
                    'search'        => 'Buscar',
            ...
            'footer' => [
                ...
                'footer-text'            => '© S Nails Cosmetics :current_year. Todos los derechos reservados.',
                'locale'                 => 'Idioma',
